...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    [Header("Ivan's Zipline")]
    [Tooltip("Is Ziphook Powerup equipped")]
    public bool HasZiphook = false;
    [Tooltip("Is character currently zipping")]
    public bool IsZipping = false;
    [Tooltip("Is character within trigger zone for a zipline -> Use this as a visual indicator")]
    public bool WithinZipTrigger = false;

    public UnityAction<bool> onStanceChanged;

    [Header("Sven's Platforms")]
    public bool onPlatform; //manually added bool to check if a player is on platform
    ...
    void HandleCharacterMovement()
    {
        ...
        //changed velocity calculation for if player is on platform
        if (onPlatform){
            m_Controller.Move(characterVelocity * Time.deltaTime + platformVelocity * Time.deltaTime);
        } else {
